  ...
  commands: {
    play: {
      ...
      errors: {
        ...
        generic_error: 'An error occurred whilst trying to play the song',
      },
      success: {
    ...
    stop: {
      ...
      errors: {
        ...
        different_voice_channel:
          'You need to be in the same voice channel as me',
        generic_error: 'An error occurred whilst trying to stop the music',
      },
      success: {
    ...
    pause: {
      ...
      errors: {
        ...
        generic_error: 'An error occurred whilst pausing the music',
      },
      success: {
        title: 'Music Paused',
    ...
    resume: {
      ...
      errors: {
        ...
        generic_error: 'An error occurred whilst resuming the music',
      },
      success: {
        title: 'Music Resumed',
    ...
    skip: {
      ...
      errors: {
        ...
        generic_error: 'An error occurred whilst skipping the song',
      },
      success: {
        title: 'Song Skipped',
    ...
    nowplaying: {
      name: 'nowplaying',
      description: 'View information about the currently playing song',
      errors: {
        no_member_info: 'Unable to retrieve your voice information',
        not_in_voice: 'You must be in a voice channel',
        no_player: 'There is nothing playing right now',
        no_track: 'No track is currently being played',
        different_voice_channel:
          'You need to be in the same voice channel as me',
      },
      success: {
        title: '🎵 Now Playing',
        description: 'Details of the current track: **{{track}}**',
      },
      fields: {
        track: '🎶 Track',
        author: '👤 Artist',
    ...
    shuffle: {
      ...
      errors: {
        ...
        generic_error: 'An error occurred whilst shuffling the queue',
      },
      success: {
    ...
    volume: {
      ...
      errors: {
        ...
        generic_error: 'An error occurred whilst adjusting the volume',
      },
      success: {
    ...
    loop: {
      ...
      errors: {
        ...
        different_voice_channel:
          'You need to be in the same voice channel as me',
        generic_error: 'An error occurred whilst configuring loop',
      },
      success: {
